...
export function Navbar() {
  ...
  return (
    <nav className={cn(
      ...
      isScrolled 
        ? "bg-[#DC2626]/95 backdrop-blur-md shadow-lg border-white/10 py-0" 
        : "bg-[#DC2626] border-white/20 py-2"
    )}>
      <div className={cn(
      ...
      {isOpen && (
        <motion.div 
            ...
            className="fixed inset-0 top-0 left-0 w-screen h-screen z-[9999] bg-[#DC2626] text-white flex flex-col overflow-hidden"
            style={{ backgroundColor: "#DC2626" }}
        >
            {/* Header Row */}
            <div className="flex items-center justify-between py-4 pr-5 pl-5 border-b border-white/20 bg-[#DC2626]">
                 {/* Left: Logo */}
